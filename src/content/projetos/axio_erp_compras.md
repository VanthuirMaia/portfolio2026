...
- xhtml2pdf
- WeasyPrint
- ReportLab objetivo: "Modernizar e automatizar processos de compras empresariais, reduzindo processos manuais e proporcionando controle total sobre o ciclo de aquisições." imagens:
...
- Sistema de autenticação Django com grupos de permissão customizados
- Criptografia de dados sensíveis (cryptography, pyHanko)
...
Estruturei o projeto em apps Django independentes (core, solicitacoes, pedidos, cadastro), facilitando manutenção e permitindo escalabilidade futura do sistema.
...
- Dashboard analytics com métricas em tempo real e gráficos interativos (Chart.js)
